                    ...
                    <div class="col-md-9 card-header p-3">
                        ...
                        <div class="tab-content mt-5" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="addproperty" role="tabpanel" aria-labelledby="home-tab">
                                                ...
                                                <select class="form-control rounded-0">
                                                    <optgroup label="Please Select - >">
                                                        ...
                                                        <optgroup label="Entire House">
                                                            ...
                                                            <option>Bunglove</option>
                                                            <option>End Terraced</option>
                                                        </optgroup>
                                                        <optgroup label="Entire Flat">
                                                            <option>Flat</option>
                                                            <option>Pentchcuse</option>
                                                            <option>__________</option>
                                                        </optgroup>
                                                        <optgroup label="Other Property Types">
                                                            <option>Mobile Home</option>
                                                            <option>House Bcat</option>
                                                        </optgroup>
                                                    </optgroup>
                                                </select>
                                            </div>  
                                ...
                                <h3>Terms</h3>
                                <input type="checkbox" id="checkmark" name="markcheck"> <strong>Tick Here To Agree To The OpenRent Terms:</strong>
